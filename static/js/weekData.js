...
function displayEarthquakeInfo(earthquake) {
    const content = `
        ...
        <p><strong><span style="color: #5C8374;">Local Time:</span></strong> ${earthquake["Local Time (Morocco)"]}</p>
        <p><strong><span style="color: #5C8374;">Type:</span></strong> ${earthquake["Type"]}</p>
